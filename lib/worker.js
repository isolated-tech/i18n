  ...
  switch (fileType) {
    ...
    case 'js':
      try {
        ...
        // acorn.walk.simple(syntaxTree, {
        //   VariableDeclaration(node) {
        //     if (node.declarations[0].init) {
        //       parsedObject = node.declarations[0].init
        //     }
        //   },
        //   ExportNamedDeclaration(node) {
        //     if (node.declaration) {
        //       parsedObject = node.declaration.declarations[0].init
        //     }
        //   },
        // })
        self.postMessage({
        ...
        return syntaxTree
        // return parsedObject ? parsedObject : null
      } catch (jsError) {
        self.postMessage({
          status: 'error',
          output: {
